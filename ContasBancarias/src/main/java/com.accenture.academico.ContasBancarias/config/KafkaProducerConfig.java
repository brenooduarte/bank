...
public class KafkaProducerConfig {
    ...
    @Bean
    public KafkaTemplate<String, MensagemOperacao> kafkaTemplate() {
        return new KafkaTemplate<>(producerFactory());
    }

    @Bean
    public ProducerFactory<String, MensagemOperacao> producerFactory() {
    ...
    @Bean
    public NewTopic contaRequestTopicBuilder() {
        return TopicBuilder
